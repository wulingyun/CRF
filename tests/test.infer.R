...
test.infer("CutsetChain", infer.cutsetChain, small.crf, small.answer, 1e-8, c(1))
test.infer("Sample", infer.sample, small.crf, small.answer, 1e-3, sample.exact, 100000000)
...
test.infer("CutsetChain", infer.cutsetChain, chain.crf, chain.answer, 1e-8, c(1))
test.infer("Sample", infer.sample, chain.crf, chain.answer, 1e-1, sample.chain, 1000000)
...
test.infer("Sample", infer.sample, tree.crf, tree.answer, 1e-1, sample.tree, 1000000)
...
test.infer("CutsetChain", infer.cutsetChain, loop.crf, loop.answer, 1e-8, c(1))
test.infer("Sample", infer.sample, loop.crf, loop.answer, 1e-3, sample.exact, 100000000)
...
test.infer("Sample", infer.sample, clique.crf, clique.answer, 1e-3, sample.exact, 100000000)
