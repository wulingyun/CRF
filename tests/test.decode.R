...
test.decode("JunctionTree", decode.junction, small.crf, small.answer)
...
test.decode("ILP", decode.ilp, small.crf, small.answer)
test.decode("ILP (LP Rounding)", decode.ilp, small.crf, small.answer, lp.rounding = T)
...
test.decode("JunctionTree", decode.junction, chain.crf, chain.answer)
...
test.decode("ILP", decode.ilp, chain.crf, chain.answer)
test.decode("ILP (LP Rounding)", decode.ilp, chain.crf, chain.answer, lp.rounding = T)
...
test.decode("JunctionTree", decode.junction, tree.crf, tree.answer)
...
test.decode("ILP", decode.ilp, tree.crf, tree.answer)
test.decode("ILP (LP Rounding)", decode.ilp, tree.crf, tree.answer, lp.rounding = T)
...
test.decode("JunctionTree", decode.junction, loop.crf, loop.answer)
...
test.decode("ILP", decode.ilp, loop.crf, loop.answer)
test.decode("ILP (LP Rounding)", decode.ilp, loop.crf, loop.answer, lp.rounding = T)

cat("Testing dataset Clique ...\n")
data(Clique)
test.decode("Cutset", decode.cutset, clique.crf, clique.answer, c(1,3))
test.decode("JunctionTree", decode.junction, clique.crf, clique.answer)
...
test.decode("ILP", decode.ilp, clique.crf, clique.answer)
test.decode("ILP (LP Rounding)", decode.ilp, clique.crf, clique.answer, lp.rounding = T)
