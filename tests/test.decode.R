...
test.decode("ICM (Restart)", decode.icm, small.crf, small.answer, restart = T)
...
test.decode("ICM (Restart)", decode.icm, chain.crf, chain.answer, restart = T)
...
test.decode("ICM (Restart)", decode.icm, tree.crf, tree.answer, restart = T)
...
test.decode("ICM (Restart)", decode.icm, loop.crf, loop.answer, restart = T)
...
test.decode("ICM (Restart)", decode.icm, clique.crf, clique.answer, restart = T)
