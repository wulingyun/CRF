...
test.sample("CutsetChain", sample.cutsetChain, small.crf, small.answer, 0.01, 10000, c(1))
...
test.sample("CutsetChain", sample.cutsetChain, chain.crf, chain.answer, 0.01, 10000, c(1))
...
test.sample("CutsetChain", sample.cutsetChain, loop.crf, loop.answer, 0.01, 10000, c(1))
